...
class Ui_ADBenQ(object):
    def setupUi(self, ADBenQ):
        ...
        self.header_container.addItem(self.horizontalSpacer)
        ...
        self.power_buttons_container = QHBoxLayout()
        self.power_buttons_container.setObjectName("power_buttons_container")
        self.turn_off_button = QPushButton(self.general_tab)
        self.turn_off_button.setObjectName("turn_off_button")

        self.power_buttons_container.addWidget(self.turn_off_button)

        self.reboot_button = QPushButton(self.general_tab)
        self.reboot_button.setObjectName("reboot_button")

        self.power_buttons_container.addWidget(self.reboot_button)

        self.footer_left_container.addLayout(self.power_buttons_container)

        self.battery_container = QHBoxLayout()
        self.battery_container.setObjectName("battery_container")
        self.battery_container.setSizeConstraint(
            QLayout.SizeConstraint.SetDefaultConstraint
        )
        ...
        self.volume_label_container.setObjectName("volume_label_container")
        ...
        self.volume_slider_show_checkbox.setObjectName("volume_slider_show_checkbox")
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/media/src/media/left.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/media/src/media/back.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/media/src/media/right.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon4 = QIcon()
        icon4.addFile(
            ":/media/src/media/pause_circle.svg",
            QSize(),
            QIcon.Mode.Normal,
            QIcon.State.Off,
        )
        ...
        icon5 = QIcon()
        icon5.addFile(
            ":/media/src/media/down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon6 = QIcon()
        icon6.addFile(
            ":/media/src/media/enter.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon7 = QIcon()
        icon7.addFile(
            ":/media/src/media/up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
    ...
    def retranslateUi(self, ADBenQ):
        ADBenQ.setWindowTitle(
            QCoreApplication.translate("ADBenQ", "ADBenQ - v0.2.3-alpha", None)
        )
        ...
        self.turn_off_button.setText(
            QCoreApplication.translate("ADBenQ", "Turn Off", None)
        )
        self.reboot_button.setText(QCoreApplication.translate("ADBenQ", "Reboot", None))
        ...
        self.volume_slider_show_checkbox.setText(
            QCoreApplication.translate("ADBenQ", "Show", None)
        )
